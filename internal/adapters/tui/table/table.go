...
//
// Vendored from github.com/charmbracelet/bubbles@v1.0.0/table (MIT, © Charmbracelet)
// with one fix: cells are truncated with the ANSI-aware ansi.Truncate instead of
// runewidth.Truncate, so styled (colored) cell values render correctly.
package table
